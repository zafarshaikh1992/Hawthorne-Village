...
const config = {
  ...
  hero: {
    eyebrow: "Cosmetic dentistry in Milton",
    ...
    image: {
      ...
      alt: "Cosmetic dentistry smile makeover at Hawthorne Village Dental Care in Milton",
    },
    stats: [
      { k: "8", v: "shades with Zoom whitening" },
      { k: "12", v: "community awards" },
      { k: "4.7★", v: "435+ Google reviews" },
      { k: "0%", v: "Financing available" },
    ],
    floatBottomLeft: { icon: "Award", label: "Dr. Raju Sarna", value: "Cosmetic dentistry leader" },
    floatTopRight: { icon: "Sparkles", title: "Science meets art", sub: "in every restoration" },
  },
  ...
  intro: {
    eyebrow: "What is cosmetic dentistry",
    ...
    floatCards: [
      { icon: "Gem", title: "Porcelain & composite", sub: "strength, durability, beauty" },
      { icon: "Leaf", title: "No metal", sub: "bonded to tooth structure" },
    ],
    parts: [
      {
        icon: "Stethoscope",
  ...
  context: {
    eyebrow: "Why smiles get held back",
    titleA: "What stands between you",
    titleB: "and the smile you want.",
    feature: {
      image: {
  ...
  benefits: {
    eyebrow: "Benefits of cosmetic dentistry",
    titleA: "Why patients invest",
    titleB: "in their smile.",
    stat: {
      icon: "Sun",
      value: "8",
      label: "shades brighter with Zoom",
      note: "In-office Zoom whitening lightens teeth up to 8 shades in one visit, and take-home trays maintain results for years.",
    },
    cards: [
      {
        icon: "Gem",
      ...
      {
        icon: "Leaf",
        title: "Bonded, conservative care",
        desc: "Modern restorations bond directly to tooth structure, preserving more of your natural tooth than older techniques.",
      },
      {
        icon: "Heart",
      ...
      {
        icon: "Trophy",
        title: "Function and beauty together",
        desc: "Because every treatment has a cosmetic and functional component, your smile works as well as it looks.",
      },
    ],
    cta: {
      title: "Curious what your smile could look like?",
      sub: "Book a consultation with Dr. Sarna and see which options genuinely fit your goals.",
    },
  },
  ...
  options: {
    ...
    titleA: "One goal,",
    titleB: "many ways to reach it.",
    cards: [
      {
        title: "Teeth whitening",
        desc: "In-office Zoom whitening lightens teeth up to 8 shades in one visit, with take-home custom trays to maintain results for years.",
      },
      {
      ...
      },
      {
        ...
        desc: "Composite fillings matched to your tooth shade and all-ceramic crowns replace dark, aging dental work.",
      },
      {
        title: "Implants & orthodontics",
        desc: "For missing or crowded teeth, implants, bridges, braces and Invisalign restore both the look and function of your smile.",
      },
    ],
  },

  galleryId: "tooth-whitening",

  whyHere: {
    titleA: "Cosmetic results come from",
    titleB: "judgment, not gadgets.",
    paragraph:
      "Dr. Sarna is a recognized leader in cosmetic, restorative and implant dentistry with an emphasis on re-creating natural aesthetic beauty. Trained at UCSF and UCLA, he pairs that experience with technology that lets you see and feel the difference at every step.",
    items: [
      {
        icon: "Award",
        name: "A recognized cosmetic leader",
        benefit:
          "Dr. Sarna's training at UCSF and UCLA and his emphasis on natural aesthetics mean your smile is designed, not just repaired.",
      },
      {
        icon: "Eye",
        name: "See your smile first",
        benefit:
          "The iTero digital scanner shows a simulated preview of your smile before you commit to Invisalign or orthodontic treatment.",
      },
      {
        icon: "Sun",
      ...
      {
        icon: "Wand2",
        name: "Comfort at every step",
        benefit:
          "The Wand computer-controlled anaesthesia and oral sedation options make cosmetic treatment calm, even for anxious patients.",
      },
    ],
  },
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Yes. In-office Zoom whitening lightens teeth up to 8 shades in one visit, and take-home custom trays maintain the results for years. It's usually the fastest, simplest place to start a smile improvement.",
    },
    {
