...
const config = {
  ...
  meta: {
    title: "TMJ Treatment Specialist in Milton, ON - Hawthorne Village Dental Care",
    description:
      "Call Hawthorne Village Dental Care for TMJ treatment. Our TMJ Specialist uses Botox for treatment of migraines, neck and shoulder stiffness and dizziness.",
    procedure: {
  ...
  hero: {
    eyebrow: "Botox and TMJ treatment in Milton",
    ...
    image: {
      ...
      alt: "TMJ and Botox treatment for jaw pain and headaches at Hawthorne Village Dental Care",
    },
    stats: [
      { k: "2–3", v: "Treatments for full benefit" },
      { k: "12 wk", v: "Treatment intervals" },
      { k: "BOTOX®", v: "For chronic migraines" },
      { k: "0%", v: "Financing available" },
    ],
    floatBottomLeft: { icon: "Brain", label: "Chronic migraines", value: "BOTOX® can prevent them" },
    floatTopRight: { icon: "ShieldCheck", title: "Excellent safety record", sub: "well-established treatment" },
  },
  ...
  intro: {
    ...
    floatCards: [
      { icon: "Activity", title: "Clicking or locking?", sub: "your jaw is telling you something" },
      { icon: "Brain", title: "Migraine relief", sub: "discovered through Botox" },
    ],
    parts: [
      {
        icon: "Stethoscope",
    ...
    closingNote:
      "Patients may need a set of 2–3 treatments before maximum benefit is seen, spaced at 12-week intervals.",
  },

  context: {
    eyebrow: "Signs of TMJ dysfunction",
    titleA: "Is your jaw behind",
    titleB: "your headaches?",
    feature: {
      image: {
        src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=1000&q=80&auto=format&fit=crop",
        alt: "A patient seeking relief from chronic jaw pain and headaches",
      },
  ...
  benefits: {
    eyebrow: "Benefits of TMJ treatment",
    titleA: "Why patients treat the joint,",
    titleB: "not just the pain.",
    stat: {
      icon: "Timer",
      value: "12 wk",
      label: "between BOTOX® treatments",
      note: "A set of 2–3 treatments, spaced at 12-week intervals, is typically needed for maximum benefit.",
    },
    cards: [
      {
        icon: "Brain",
      ...
      },
      {
        ...
        desc: "Botox's tolerability and safety record for facial muscle treatment are excellent and well documented.",
      },
      {
        icon: "Utensils",
        title: "Comfortable chewing again",
        desc: "Restoring proper joint function means eating, speaking and yawning stop being painful events.",
      },
      {
        icon: "Waves",
        title: "Relief beyond the jaw",
        desc: "Because the body compensates for TMJ trouble, treating it can ease neck, shoulder and back tension too.",
      },
      {
        icon: "Target",
        title: "Treats the root cause",
        desc: "Correcting how your teeth support your jaw addresses the dysfunction itself, not just its symptoms.",
      },
    ],
    cta: {
      title: "Chronic headaches, jaw clicking or ear ringing?",
      sub: "Speak with Dr. Sarna about whether TMJ treatment could be the answer.",
    },
  },

  options: {
    eyebrow: "How we treat TMJ",
    titleA: "Matched to",
    titleB: "your symptoms.",
    cards: [
      {
        title: "TMJ assessment",
        desc: "A thorough look at your joints, bite and muscle system to pinpoint what's driving the symptoms.",
      },
      {
        title: "BOTOX® therapy",
        desc: "Prescription injections into overworked muscles to prevent chronic migraine headaches.",
      },
      {
      ...
      {
        title: "Night guards",
        desc: "Custom guards that protect teeth and calm clenching and grinding while you sleep.",
      },
    ],
  },
    ...
    items: [
      {
        ...
        benefit:
          "Dr. Sarna's restorative background means bite problems behind TMJ trouble get recognized and corrected.",
      },
      {
        icon: "ScanLine",
        name: "3D CBCT imaging",
        benefit:
          "Low-radiation 3D imaging shows the joint and jaw structure precisely before treatment decisions are made.",
      },
      {
        icon: "Syringe",
        name: "BOTOX® administered in-office",
        benefit:
          "Therapeutic Botox for chronic migraines is delivered by the same doctor who understands your bite.",
      },
      {
        icon: "Clock",
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Clicking and popping sounds, headaches and migraines, neck and facial pain, locking of the jaw, and ringing in the ears. Prolonged dysfunction can also pull in the neck, throat, shoulders and back as the body compensates.",
    },
    {
    ...
    },
    {
      ...
      a: "BOTOX® is a prescription medicine injected into muscles that's used to prevent headaches in adults with chronic migraines. Its benefit for headaches was discovered when patients receiving cosmetic Botox reported their migraines improving.",
    },
    {
      q: "Is Botox safe?",
      a: "Botox has an excellent tolerability and safety record in facial muscle treatment, built over decades of use for wrinkles, facial tics and spasms as well as therapeutic care.",
    },
    {
      q: "How many treatments will I need?",
      a: "Patients may require a set of 2–3 treatments before maximum benefit is seen, with TMJ treatments spaced at 12-week intervals. Dr. Sarna will map out the plan at your assessment.",
    },
    {
