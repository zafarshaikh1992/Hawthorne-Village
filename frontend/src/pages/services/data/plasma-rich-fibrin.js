...
const config = {
  ...
  meta: {
    ...
    procedure: {
      ...
      description:
        "Plasma Rich Fibrin (PRF) is harnessed from the patient's own blood and used in surgical procedures such as dental implants, soft tissue grafting, bone grafting and extractions to enhance the body's regenerative capabilities.",
      howPerformed:
        "A small sample of the patient's own blood is drawn and concentrated into a fibrin matrix enriched with platelets, growth factors and cytokines, then placed at the surgical site to enhance soft tissue and bone regeneration.",
    },
  },

  hero: {
    eyebrow: "PRF dental treatment in Milton",
    ...
    image: {
      ...
      alt: "Plasma Rich Fibrin preparation at Hawthorne Village Dental Care in Milton",
    },
    stats: [
      { k: "100%", v: "Your own platelets" },
      { k: "ICOI", v: "Implantology Fellow" },
      { k: "3D", v: "CBCT-guided surgery" },
      { k: "0%", v: "Financing available" },
    ],
    floatBottomLeft: { icon: "Award", label: "Dr. Raju Sarna", value: "ICOI Fellow, Implantology" },
    floatTopRight: { icon: "Droplets", title: "Natural healing", sub: "from your own blood" },
  },
  ...
  intro: {
    eyebrow: "What is Plasma Rich Fibrin",
    titleA: "A healing boost",
    titleB: "made from you.",
    paragraph:
      "PRF is a fibrin matrix enriched with platelets, which contain many growth factors and cytokines. These growth factors enhance an individual's regenerative capabilities with respect to soft tissue and bone. Here's how it works, step by step:",
    image: {
      src: "https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=1000&q=80&auto=format&fit=crop",
      alt: "Calm, comfortable chairside care during PRF-assisted treatment",
    },
    floatCards: [
      { icon: "Droplets", title: "From your own blood", sub: "nothing synthetic added" },
      { icon: "Leaf", title: "Growth factors & cytokines", sub: "that drive regeneration" },
    ],
    parts: [
      {
        icon: "Syringe",
  ...
  context: {
    eyebrow: "Why healing speed matters",
    titleA: "Good surgery is",
    titleB: "only half the story.",
    feature: {
      image: {
        src: "https://images.unsplash.com/photo-1522849696084-818b29dfe210?w=800&q=75&auto=format&fit=crop",
        alt: "Oral surgery patient whose recovery is supported by Plasma Rich Fibrin",
      },
      headline: "How you heal decides how well treatment works.",
      caption:
        "Dr. Sarna uses PRF across implant, grafting and extraction cases because the quality of healing shapes the quality of the result.",
    },
    cards: [
      {
        icon: "Activity",
  ...
  benefits: {
    eyebrow: "Benefits of PRF",
    titleA: "Why we reach for",
    titleB: "your own platelets.",
    stat: {
      icon: "Droplets",
      value: "100%",
    ...
    cards: [
      ...
      {
        icon: "HeartPulse",
        title: "Enhances soft tissue healing",
        desc: "The growth factors in PRF enhance your regenerative capability where gums and soft tissue need to rebuild.",
      },
      {
        icon: "Bone",
      ...
      {
        icon: "Puzzle",
        title: "Works across procedures",
        desc: "PRF is used in many surgical procedures: dental implants, soft tissue grafting, bone grafting and extractions.",
      },
      {
        icon: "Star",
  ...
  options: {
    eyebrow: "Where PRF helps",
    titleA: "One technique,",
    titleB: "many procedures.",
    cards: [
      {
      ...
      },
      {
        ...
        desc: "Placed alongside grafting material, PRF enhances the regeneration that turns a graft into solid jawbone.",
      },
      {
        title: "Soft tissue grafting",
        desc: "In procedures like connective tissue grafts, PRF helps the transferred gum tissue heal and settle.",
      },
      {
        title: "Extractions & wisdom teeth",
        desc: "After a tooth is removed, PRF placed in the socket gives healing a concentrated, natural boost.",
      },
    ],
  },
  ...
  whyHere: {
    ...
    items: [
      ...
      {
        icon: "Scan",
        name: "3D CBCT-guided surgery",
        benefit:
          "Implants, grafts and extractions are planned on a 3D scan of your jaw with ultra-low radiation, so PRF is placed exactly where healing happens.",
      },
      {
        icon: "Stethoscope",
  ...
  faqs: [
    {
      q: "What is Plasma Rich Fibrin (PRF)?",
      a: "PRF is harnessed from your own blood and used in many surgical procedures. It's a fibrin matrix enriched with platelets, which contain many growth factors and cytokines that enhance your body's regenerative capabilities with respect to soft tissue and bone.",
    },
    {
      q: "How is PRF made?",
      a: "A small sample of your own blood is drawn chairside and concentrated into a fibrin matrix rich in platelets. That matrix is then placed directly at the surgical site, where its growth factors go to work on healing.",
    },
    {
      q: "Which procedures use PRF?",
      a: "PRF is used in many surgical procedures at our Milton clinic, including dental implants, soft tissue grafting, bone grafting and extractions.",
    },
    {
      q: "Is PRF safe?",
    ...
    },
    {
      ...
      a: "PRF is part of your overall surgical plan, and everything is set out in a written estimate before treatment begins. We bill your insurance directly, accept the Canadian Dental Care Plan, and offer 0% financing over 6 to 24 months.",
    },
    {
