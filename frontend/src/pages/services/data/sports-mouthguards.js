...
const config = {
  ...
  meta: {
    title: "Sports Dentistry, Sports Mouthguards in Milton, ON",
    description:
      "Hawthorne Village Dental Care specializes in sports dentistry and provide sports mouthguards for the treatment of orofacial pain from serious injuries.",
    procedure: {
  ...
  hero: {
    eyebrow: "Sports dentistry in Milton",
    ...
    image: {
      ...
      alt: "Custom-fitted sports mouthguard made at Hawthorne Village Dental Care in Milton",
    },
    stats: [
      { k: "3", v: "Mouthguard types, 1 winner" },
      { k: "Custom", v: "Designed in-office" },
      { k: "All ages", v: "Kids and adults" },
      { k: "0%", v: "Financing available" },
    ],
    floatBottomLeft: { icon: "Trophy", label: "Every sport", value: "Hockey, football and beyond" },
    floatTopRight: { icon: "ShieldCheck", title: "Custom protection", sub: "the most effective type" },
  },
  ...
  intro: {
    eyebrow: "What is sports dentistry",
    titleA: "Prevention,",
    ...
    floatCards: [
      { icon: "CalendarCheck", title: "Pre-season screening", sub: "essential to preventing injuries" },
      { icon: "Ruler", title: "Made for your mouth", sub: "not a boil-and-bite" },
    ],
    parts: [
      {
        icon: "Stethoscope",
    ...
    closingNote:
      "Store-bought guards exist, but the athlete wearing braces, bridgework or a growing smile deserves better than one-size-fits-most.",
  },

  context: {
    eyebrow: "Why custom matters",
    titleA: "Three kinds of mouthguard.",
    titleB: "Only one built for you.",
    feature: {
      image: {
        src: "https://images.unsplash.com/photo-1609840114035-3c981b782dfe?w=1000&q=80&auto=format&fit=crop",
        alt: "Emergency dental care for a sports injury that a mouthguard could have prevented",
      },
  ...
  benefits: {
    eyebrow: "Benefits of a custom guard",
    titleA: "Why athletes wear",
    titleB: "the one we make.",
    stat: {
      icon: "Trophy",
      value: "1 of 3",
      label: "guard types is truly effective",
      note: "Of the three mouthguard types, the custom-designed guard made in our office is the most efficient and effective.",
    },
    cards: [
      {
        icon: "ShieldCheck",
        title: "Real impact protection",
        desc: "A precise fit spreads and absorbs impact forces the way loose, generic guards can't.",
      },
      {
        icon: "Feather",
        title: "Comfortable enough to wear",
        desc: "Guards that fit get worn. Athletes talk, breathe and drink easily, so the guard stays in.",
      },
      {
        icon: "Baby",
      ...
      {
        icon: "Puzzle",
        title: "Works with braces and bridgework",
        desc: "Custom design protects orthodontics, crowns and artificial teeth that store guards ignore.",
      },
      {
        icon: "Gem",
        title: "Durable, season after season",
        desc: "Professionally made materials outlast boil-and-bite guards chewed soft by mid-season.",
      },
    ],
    cta: {
      title: "Season starting soon?",
      sub: "Book a pre-season screening and custom fitting for you or your child.",
    },
  },

  options: {
    eyebrow: "Sports dentistry services",
    titleA: "Protection for",
    titleB: "every athlete.",
    cards: [
      {
        title: "Pre-season screenings",
        desc: "Full examinations covering health history, bite, at-risk teeth, dental work and injury risk.",
      },
      {
        title: "Custom mouthguards",
        desc: "Designed and built in-office for hockey, football and every sport in between.",
      },
      {
        title: "Kids and teens",
        desc: "Guards designed around growing mouths, erupting teeth and orthodontic treatment.",
      },
      {
        title: "Injury care",
        desc: "If an orofacial injury does happen, same-day emergency slots get athletes seen fast.",
      },
    ],
  },
  ...
  whyHere: {
    ...
    items: [
      {
        icon: "Award",
        name: "Sports-injury prevention training",
        benefit:
          "The team is specifically trained in preventing orofacial athletic injuries, not just treating them.",
      },
      {
        icon: "Gem",
      ...
      },
      {
        ...
        benefit:
          "If a dental injury happens mid-game, we hold appointments every weekday to see athletes fast.",
      },
      {
        icon: "Clock",
        name: "Evenings and Saturdays",
        benefit:
          "Fittings that fit around practice: open until 7 PM weekdays and 2 PM Saturdays.",
      },
    ],
  },
  ...
  faqs: [
    {
      q: "Are custom mouthguards really better than store-bought?",
      a: "Yes. There are three types of sports mouthguards, and the custom-designed guard made in our office is the most efficient and effective. Fitted boil-and-bite and ready-made store guards are inexpensive, but they're also the least effective.",
    },
    {
    ...
    },
    {
      ...
      a: "Adult guards typically last multiple seasons with proper care. Children's guards are checked as they grow, since erupting teeth change the fit.",
    },
    {
      q: "What if a dental injury happens during a game?",
      a: "Call us at (905) 864-3368. For a knocked-out permanent tooth, keep it moist in milk or saliva and come in within 30 minutes for the best chance of saving it. We hold same-day emergency slots every weekday.",
    },
    {
      q: "Does insurance cover sports mouthguards?",
      a: "Many dental plans cover custom athletic mouthguards. We confirm your coverage, provide a written quote, and bill your insurer directly.",
    },
  ],
};
