...
const config = {
  slug: "invisalign",
  name: "Invisalign",
  testIdPrefix: "invisalign",

  meta: {
    title: "Invisalign in Milton, ON - Hawthorne Village Dental Care",
    description:
      "Straighten your teeth without metal bands or brackets. Hawthorne Village Dental Care offers Invisalign clear aligners with iTero smile previews in Milton. Book your appointment now.",
    procedure: {
      alternateName: "Invisalign Clear Aligner Therapy",
      description:
        "Invisalign straightens teeth using a series of clear plastic aligners instead of traditional metal bands and brackets, so it is difficult to tell you are wearing them at all.",
      howPerformed:
        "An iTero 3D digital scan builds a computer-generated model of your teeth and simulates your finished smile. A series of custom clear aligners is fabricated; each is worn for approximately two weeks before moving to the next, until the teeth reach their correct position.",
    },
  },

  hero: {
    eyebrow: "Invisalign in Milton",
    ...
    image: {
      ...
      alt: "Invisalign clear aligner treatment at Hawthorne Village Dental Care in Milton",
    },
    stats: [
      { k: "iTero", v: "Smile preview scanner" },
      { k: "2 wks", v: "Per aligner stage" },
      { k: "0%", v: "Financing 12–24 months" },
      { k: "7 PM", v: "Evening appointments" },
    ],
    floatBottomLeft: { icon: "Award", label: "Dr. Raju Sarna", value: "Invisalign treatment in Milton" },
    floatTopRight: { icon: "Eye", title: "Nearly invisible", sub: "most people never notice" },
  },
  ...
  intro: {
    ...
    floatCards: [
      { icon: "Eye", title: "See your result", sub: "before you start" },
      { icon: "Hand", title: "Removable", sub: "eat and brush normally" },
    ],
    parts: [
      {
        icon: "Scan",
  ...
  context: {
    eyebrow: "Why patients choose clear aligners",
    titleA: "Wanted straighter teeth,",
    titleB: "just not the braces?",
    feature: {
      image: {
  ...
  benefits: {
    eyebrow: "Benefits of Invisalign",
    titleA: "Why patients choose",
    titleB: "Invisalign here.",
    stat: {
      icon: "Hourglass",
      value: "2 wks",
      label: "per aligner in the series",
      note: "Each aligner is worn for approximately two weeks before you progress to the next, steadily guiding teeth to the correct position.",
    },
    cards: [
      {
        icon: "Eye",
      ...
      {
        icon: "Utensils",
        title: "Removable for real life",
        desc: "Take the aligners out to eat, brush and floss. No food restrictions, no wires to clean around.",
      },
      {
        icon: "Feather",
      ...
      {
        icon: "Scan",
        title: "A preview before you commit",
        desc: "The iTero scanner shows a 3D simulation of your finished smile before treatment begins, based on over 400,000 documented cases.",
      },
      {
        icon: "SmilePlus",
  ...
  options: {
    eyebrow: "Your Invisalign journey",
    titleA: "More than a set",
    titleB: "of clear trays.",
    cards: [
      {
      ...
      },
      {
        ...
        desc: "Clear aligners work for both, and our evening and Saturday hours make check-in visits easy around school and work.",
      },
      {
        title: "Traditional braces alternative",
        desc: "Not every case suits aligners. We also offer custom Insignia Damon brackets, so you get the option that fits your teeth best.",
      },
      {
  ...
  whyHere: {
    ...
    items: [
      ...
      {
        icon: "Puzzle",
        name: "Every orthodontic option in-house",
        benefit:
          "Aligners, custom Damon brackets and traditional braces under one roof, so your treatment is chosen for your teeth, not our inventory.",
      },
      {
        icon: "Award",
        name: "Dr. Raju Sarna",
        benefit:
          "An ICOI Fellow trained at UCSF and UCLA, focused on results that look natural and work in harmony with your features.",
      },
      {
        icon: "Clock",
  ...
  faqs: [
    {
      q: "What is Invisalign, exactly?",
      a: "Invisalign is a way to straighten teeth using clear plastic aligners instead of traditional metal bands and brackets. A series of custom aligners gradually moves your teeth into the correct position, and because they are clear, it is difficult to tell you are wearing them.",
    },
    {
      q: "How does Invisalign treatment work?",
      a: "You wear each aligner for approximately two weeks, then progress to the next fitted aligner in the series. Each one moves your teeth a little further, continuing the sequence until your teeth are in the correct position.",
    },
    {
      q: "Is Invisalign more expensive than braces?",
      a: "For most adult cases the price is very similar. We provide a written estimate before treatment begins and offer 0% financing over 12 to 24 months so you can spread the cost.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes. The aligners are removable, so you take them out to eat and to brush and floss. Unlike fixed braces, there are no food restrictions and no wires to clean around.",
    },
    {
      q: "How do I know if I am a candidate for Invisalign?",
      a: "Book a consultation at our Milton clinic. Dr. Sarna will assess your teeth, and our iTero 3D scanner can show you a simulation of your expected result before you decide. If aligners are not the right fit, we offer custom Insignia Damon braces as well.",
    },
    {
