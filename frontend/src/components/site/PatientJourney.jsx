...
export default function PatientJourney() {
  const ref = useReveal();
  return (
    <section ref={ref} className="reveal py-14 md:py-20 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14 md:mb-20">
          <div className="text-[13px] uppercase tracking-[0.14em] text-[#4285F4] font-medium mb-3">How it works</div>
        ...
        <div className="relative grid md:grid-cols-4 gap-8 md:gap-6">
          ...
          {journey.map((s, i) => (
            ...
            >
              <div className="relative z-10 w-12 h-12 rounded-full bg-white border border-slate-200 text-[#4285F4] font-display font-semibold flex items-center justify-center shadow-[0_6px_20px_rgba(10,25,47,0.06)]">
                {s.step}
              </div>
